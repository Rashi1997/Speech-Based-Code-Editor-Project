...
public class TextToCommands {
  ...
  */
  ...
  public List<String> matchTerm(List<String> s, Set<String> terms) {
    ...
    for (int i = largestTermLength; i > 0; i--) {
 ...
 public void removeFirstN(int n, List<String> words) {
  ...
  public String checkForCommand(List<String> words) {
    ...
    if (command != null) {
      ...
      switch (commandString) {
        ...
        case "rename":
          // Concatenation methods
          // ex: default var declaration
          System.out.println("Renaming variable");
          break;
        default:
...
//    List<String> hardcodedwords = new ArrayList<String>();
//    hardcodedwords.add("rename");
//    hardcodedwords.add("speech");
//    hardcodedwords.add("text");
    while (words.size() > 0) {
//      printList(words);
      String command = checkForCommand(words);
      if (command.equals("rename")) {
        editorHandler.renameVariable(words);
